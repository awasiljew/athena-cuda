 ...
 * pitch == 7
 */
__device__ void esys_roe_adb_mhd_cu_dev(Real d, Real v1, Real v2, Real v3,
  Real h, Real b1, Real b2, Real b3,
  Real x, Real y,
  Real *eigenvalues,
  Real right_eigenmatrix[][7], Real left_eigenmatrix[][7], Real Gamma_1, Real Gamma_2)
{
...
__global__ void esys_roe_adb_mhd_cu(Real d, Real v1, Real v2, Real v3,
		  Real h, Real b1, Real b2, Real b3,
		  Real x, Real y,
		  Real *eigenvalues,
		  Real *right_eigenmatrix, Real *left_eigenmatrix, Real Gamma_1, Real Gamma_2)
{
	//esys_roe_adb_mhd_cu_dev(d, v1, v2, v3, h, b1, b2, b3, x, y,  eigenvalues, right_eigenmatrix, left_eigenmatrix, Gamma_1, Gamma_2);
}
